...
class GiftedChat extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if ((this.props.messages !== prevProps.messages) || (this.props.text !== prevProps.text)) {
  ...
  setMessages(messages) {
    this.state._messages = [...messages];
    
  }

  getMessages() {
    
    return this.state._messages;
  }
  ...
  onKeyboardWillShow(e) {
    if(Platform.OS !== "ios"){
      ...
      if(this.props.modalVisible && this.props.accessoryHeight == 44 + global.keyboardHeight){
  ...
  onInputSizeChanged(size) {
    ...
    if(Platform.OS == "ios"){
      if(this.props.modalVisible){
        newMessagesContainerHeight = newMessagesContainerHeight - global.keyboardHeight
      }  
    }
