...
import CustomCallout from './examples/CustomCallout';
import { decoy_masker_1,
         decoy_masker_2,
         decoy_masker_3 } from '../decoy/data.js'
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        >
          <Marker coordinate={{latitude:43.667898,longitude:-79.429443}}/>
        </MapView>
