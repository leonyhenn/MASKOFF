...
export async function ForgetPassword(info){
    try{
        var response = await fetch(server + "/users/forget",{
            method:"POST",
...
export async function getFollowedRoasts(info){
    try{
        var response = await fetch(server + "/roasts/followed",{
            method:"POST",
            headers:{'Content-type':'application/json',
                     'access-token':global.access_token
                    },
...
export async function getFollowedArticles(info){
    try{
        var response = await fetch(server + "/articles/followed",{
            method:"POST",
            headers:{'Content-type':'application/json',
                     'access-token':global.access_token
                    },
...
export async function getRecommendRoasts(info){
    try{
        var response = await fetch(server + "/roasts/recommend",{
            method:"POST",
            headers:{'Content-type':'application/json',
                     'access-token':global.access_token
                    },
...
export async function getRecommendArticles(info){
    try{
        var response = await fetch(server + "/articles/recommend",{
            method:"POST",
            headers:{'Content-type':'application/json',
                     'access-token':global.access_token
                    },
...
export async function ConfirmVerification(info){
    try{
        var response = await fetch(server + "/users/confirm",{
            method:"POST",
            headers:{'Content-type':'application/json',
                     'access-token':global.access_token
                    },
...
export async function Forget(user_info){
    try{
        var response = await fetch(server + "/users/forget",{
            method:"POST",
            headers:{'Content-type':'application/json',
...
export async function Relogin_Reload(info){
    if (info == undefined){
        return "no_location_info"   
    }
    try{
        var relogin_res = await Relogin(info)
        let json = await relogin_res.json()  
