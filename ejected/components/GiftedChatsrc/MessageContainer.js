...
import { ListView, View, StyleSheet, InteractionManager, Platform } from 'react-native';
...
export default class MessageContainer extends React.Component {
  ...
  render() {
    // console.log("MessageContainer",this.props.messages)
    const contentContainerStyle = this.props.inverted
      ? {}
      : styles.notInvertedContentContainerStyle;
    // console.log("messagesContainer",this.props.messagesContainerHeight)
    return (
      <View style={[styles.container,{height:this.props.messagesContainerHeight}]}>
        <ListView
          ...
          style={[{height:this.props.messagesContainerHeight},this.props.listViewProps.style]}
        />
      </View>
    );
  }
