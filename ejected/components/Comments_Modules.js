...
//colors
import { THEME_COLOR } from '../utility/colors.js'
  ...
  render() {
      ...
      if(this.props.comment_image){
        comment_image = <View>
          ...
          <TouchableOpacity style={CustomComposer_style.edit_button}
                            onPress={()=>{this.props.navigation.navigate("MKOF_Image_manipulator",{ImagePicker_uri:this.props.comment_image,usage:"Composer",change_comment_image:this.props.change_comment_image})}}>
            <Ionicons name="ios-build" size={20} color={THEME_COLOR}/>
          </TouchableOpacity>
        </View>
      }else{
        comment_image = null
