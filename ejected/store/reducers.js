...
const postReducer = (state={content:[{info_index:0,
	...
	if (action.type === ADD_INFO_TO_POST){
		...
		}else if(action.payload.info_type == "wechat"){
      newState = {...state}
      newState.wechat = action.payload.info
    }else if(action.payload.info_type == "cellphone"){
      newState = {...state}
      newState.cellphone = action.payload.info
    }else if(action.payload.info_type == "other_key"){
      newState = {...state}
      newState.other_key = action.payload.info
    }else if(action.payload.info_type == "other_value"){
      newState = {...state}
      newState.other_value = action.payload.info
    }
