...
def register_and_upgrade_jiangfangzhou():
    requests.post(url + "/users",json={"smacc":"jiangfangzhou","smacc_type":"WeChat","gender":"0","coordinate":{"latitude":123.321,"longitude":456.654}})
...
# test roast search
def jiangfangzhou_comment(db_id,db_type,parent_id,reply_id,content):
    return {
        "at":"user_1",
        "db_id":db_id,
...
def post_a_masker(article,headers,name):
    article["name"] = name
    files = {"1":open("/Users/study/Desktop/假数据_章文/3e89803fly1ftta7v7qspj20v91vok00.jpg","rb"),"2":open("/Users/study/Desktop/假数据_章文/cSL5-hftenia2454894.jpg","rb"),"3":open("/Users/study/Desktop/假数据_章文/v2-cddb8219f91b4765fe74f3af96880ea7_hd.jpg","rb")}
    r = requests.post(url + "/maskers",data=article,headers=headers,files=files)
    print(r.status_code)
...
article1 = {       
      "roast":json.dumps({
        "tags":["极度不舒适","作死"],
        "content":[{"type":"text/plain","filename":"​首先给没有看过的帖子的JRS一个传送门。"},
...
article2 = {
      "roast":json.dumps({
        ...
        "content":[{"type":"text/plain","filename":"​先说结论：婚恋市场真的会出现让你们大跌眼镜的情况，比如在街上看来的三分女农村家庭嫁了一个各方面都不错的男的。"},
...
article3 = {
  "roast":json.dumps({
    ...
    "content":[{"type":"text/plain","filename":"​前天晚上下班回家，女朋友说七夕买的礼物到了，我挺开心的。表示了很开心，和感谢。准备提一局fifa然后说了晚上带他去看电影。打算回来慢慢拆，慢慢欣赏。结果她就开始不高兴了，作为一个直男，一开始真没意识到。后来觉得不对劲，就去问问。重点是一开始态度极好，本着有错就改，误会我的话加以注意的原则沟通。"},
...
article4 = {
  "roast":json.dumps({
    "tags":["舔狗","前女友","极度舒适"],
    "content":[{"type":"text/plain","filename":"​我是跟她闺密先认识的，然后她闺密介绍的。。。追的时候她闺密就帮了我很多。"},
...
article6 = {
  "roast":json.dumps({
    "tags":["宿舍","结婚","老好人"],
    "content":[{"type":"text/plain","filename":"我大学宿舍老三下一周结婚，所以我今天问老三怎么安排，想今天把事定下来，这样我们宿舍当伴郎的就准备衣服，离家远的提前买票。"},
...
article7 = {
  "roast":json.dumps({
    "tags":["舔狗","分手","初恋"],
    "content":[{"type":"text/plain","filename":"  小弟准大三，这是发生在我身上最荒诞的事，小弟父母早逝，一个人生活了7年了吧，她早年和奶奶一起住，初三以前没见过父母，成绩很好，和她同村，她高三以前无任何接触。"},
...
article8 = {
  "roast":json.dumps({
    "tags":["喜欢","篮球鞋","平头哥"],
    "content":[{"type":"text/plain","filename":"Rt...我可能错过了一个爱自己的人，真的惭愧。首先说清楚，我可能逻辑不清了，打的很乱，因为现在已经接近崩溃。。。开学初8月份重新分班遇到个不错的妹子，她在班上经常找我聊，起初我没感觉啥，后来慢慢对她有感觉了。就想着:现在颜值又不如初中，痘又重新炸了回来，这人居然还能对自己有点意思。我虽然是个菜鸟，不怎么会撩妹，但这次却莫名自信，然后就顺着自己所想来做。"},
...
article9 = {
  "roast":json.dumps({
    "tags":["女朋友","自拍","同学聚会"],
    "content":[{"type":"text/plain","filename":"和女朋友谈了快两年，感情一直挺好，虽然还没有见过双方父母，但是也在微信上加了好友，商量好今年过年见面。"},
...
article10 = {
  "roast":json.dumps({
    "tags":["媳妇","二手车","娘家"],
    "content":[{"type":"text/plain","filename":"事情是这样的，由于工作原因第二天需要租车查勘（基层通信行业老哥都懂），打算借朋友的车用几天，他刚入手了一个二手车开车不是很熟悉在家放着，我说借两天朋友也同意了。从娘家吃饭回来的路上说不让借，各说各的理由。然后她说出事了人家还担责任呢，我直接对了一句，出嫩达那蛋，然后就生气了。到家路口我说把我送到那谁家门口吧，她就直接下车回家了，到家以后直接说收拾东西出去（让我去客厅睡），我当然不能忍了:凭啥出去，她就扭头直接回娘家了。"},
...
article11 = {
  "roast":json.dumps({
    "tags":["模特","800字","舒适"],
    "content":[{"type":"text/plain","filename":"某社交软件上认识了一个模特，聊了几天，留了联系方式，约了几天没约出来。后来突然有次我开玩笑的说现在出来散步吧，她说她现在正好在外面逛街，就叫我一起去逛了。"},
...
article12 = {
  "roast":json.dumps({
    "tags":["渣","青青草原","备胎"],
    "content":[{"type":"text/plain","filename":"以下是楼主兄弟所发生的真人真事看看有没有吊大的出出招   以下的内容是楼主兄弟自己编辑的，可以说那个女生是个渣了，把所有人都当成备胎，我兄弟好好对她却发现青青草原顶在头上拿不下来。"},
...
article13 = {
  "roast":json.dumps({
    "tags":["舒适","银行","理财"],
    "content":[{"type":"text/plain","filename":"小弟是银行狗一枚，被领导安排到小微支行上班（没关系没办法）身兼数职，这天正上班一个妹子进来说要咨询理财，"},
...
print(headers)
r = requests.post(url + "/roasts",data=article1,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article2,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article3,headers=headers)
print(json.loads(r.content))
rid = json.loads(r.content)["rid"]
parent_comments = []
for i in range(46):
    c1 = deepcopy(jiangfangzhou_comment(rid,"ROASTS","0","0",str(i)))
...
print(parent_comments[0])
for j in range(46):
    c1 = deepcopy(jiangfangzhou_comment(rid,"ROASTS",parent_comments[0],"0","sub"+str(j)))
    r1 = requests.post(url + "/comments",json=c1,headers=headers)
    print(r1.status_code)
    c1_cid = json.loads(r1.content)["cid"]
r = requests.post(url + "/roasts",data=article4,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article5,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article6,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article7,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article8,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article9,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article10,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article11,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article12,headers=headers)
print(json.loads(r.content))
r = requests.post(url + "/roasts",data=article13,headers=headers)
print(json.loads(r.content))


user1 = {"smacc":"user1","smacc_type":"WeChat","gender":"0","coordinate":{"latitude":123.321,"longitude":456.654}}
user2 = {"smacc":"user2","smacc_type":"WeChat","gender":"0","coordinate":{"latitude":123.321,"longitude":456.654}}
user3 = {"smacc":"user3","smacc_type":"WeChat","gender":"0","coordinate":{"latitude":123.321,"longitude":456.654}}
user4 = {"smacc":"user4","smacc_type":"WeChat","gender":"0","coordinate":{"latitude":123.321,"longitude":456.654}}
user5 = {"smacc":"user5","smacc_type":"WeChat","gender":"0","coordinate":{"latitude":123.321,"longitude":456.654}}
...
r_w = requests.post(url + "/users/write_access",json=p1,headers=headers1)
print("r_w:____",r_w.status_code,json.loads(r_w.content)["message"])
...
time.sleep(10)
print(headers1)
(mid,first_aid) = post_a_masker(masker_article1,headers1,"章文")
parent_comments = []
for i in range(46):
    c1 = deepcopy(jiangfangzhou_comment(mid,"MASKERS","0","0",str(i)))
    r1 = requests.post(url + "/comments",json=c1,headers=headers1)
    print(r1.status_code)
    c1_cid = json.loads(r1.content)["cid"]
    parent_comments.append(c1_cid)
print(parent_comments[0])
for j in range(46):
    c1 = deepcopy(jiangfangzhou_comment(mid,"MASKERS",parent_comments[0],"0","sub"+str(j)))
    r1 = requests.post(url + "/comments",json=c1,headers=headers1)
    print(r1.status_code)
    c1_cid = json.loads(r1.content)["cid"]
masker_article2 = {
...
files = {"0":open("/Users/study/Desktop/假数据_章文/Rbxi-hftenia2500242.png","rb"),"1":open("/Users/study/Desktop/假数据_章文/gBKW-hftenia2519068.jpg","rb"),"2":open("/Users/study/Desktop/假数据_章文/8721e49bly1ftlssuzty0j20ku112dk1.jpg","rb")}
r6 = requests.post(url + "/articles",data=masker_article2,headers=headers2,files=files)
print(r6.status_code)
print(json.loads(r6.content))



aid = json.loads(r6.content)["aid"]
parent_comments = []
for i in range(46):
    c1 = deepcopy(jiangfangzhou_comment(aid,"ARTICLES","0","0",str(i)))
    r1 = requests.post(url + "/comments",json=c1,headers=headers)
    print(r1.status_code,json.loads(r1.content))
    c1_cid = json.loads(r1.content)["cid"]
    parent_comments.append(c1_cid)
print(parent_comments[0])
for j in range(46):
    c1 = deepcopy(jiangfangzhou_comment(aid,"ARTICLES",parent_comments[0],"0","sub"+str(j)))
    r1 = requests.post(url + "/comments",json=c1,headers=headers)
    print(r1.status_code)
    c1_cid = json.loads(r1.content)["cid"]
...
files = {"0":open("/Users/study/Desktop/假数据_章文/595ad6fegy1ftqllvc47oj20ms8c0e81.jpg","rb"),"1":open("/Users/study/Desktop/假数据_章文/v2-27e4262cc267db567ab2fbccebf6d848_b.jpg","rb")}
r7 = requests.post(url + "/articles",data=masker_article3,headers=headers3,files=files)
print(r7.status_code)



r8 = requests.post(url + "/articles",data=masker_article4,headers=headers4,files=files)
print(r8.status_code)


files = {"0":open("/Users/study/Desktop/假数据_章文/R67U-hftenia2449125.png","rb"),"1":open("/Users/study/Desktop/假数据_章文/v2-40389313b3b31f6cfee435bda0164ea8_hd.jpg","rb")}
r9 = requests.post(url + "/articles",data=masker_article5,headers=headers5,files=files)
